CREATE TYPE "public"."tier" AS ENUM('Starter', 'Standard', 'Pro', 'Elite');--> statement-breakpoint
...
CREATE TABLE "product_customizations" (
	...
	"product_id" uuid NOT NULL,
	"class_prefix" text,
	"location_message" text DEFAULT 'Hey there! It looks like you''re from <b>{country}</b>. Enjoy pricing tailored to your location with Purchasing Power Parity. Use code <b>{coupon}</b> for an exclusive <b>{discount}%</b> off!' NOT NULL,
	"background_color" text DEFAULT '#e1b505' NOT NULL,
	"text_color" text DEFAULT '#ffffff' NOT NULL,
	"font_size" text DEFAULT '1rem' NOT NULL,
	"border_radius" text DEFAULT '0px' NOT NULL,
